...
min_freq = 3
vocab_size = 20000
basic_vocab, basic_tokenizer = build_basic_vocab(train_data, min_freq, vocab_size)

basic_text_pipeline = lambda x: basic_vocab(basic_tokenizer(x))
...
# using torch dataset
train_dataset = IMDB_Dataset(train_data, basic_vocab, basic_text_pipeline, seq_length=seq_length)
val_dataset = IMDB_Dataset(test_data, basic_vocab, basic_text_pipeline, seq_length=seq_length)
